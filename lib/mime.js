exports.ext = function () {
    var magicNumbers = {
        ...
        , "494433"            : "audio/mpeg"
        , "1a45dfa3"       : "video/webm"
        , "00000018667479703367"   : "video/mp4"
        , "00000018667479703367"   : "video/mp4"
        , "1a45dfa3934282886d61"    : "video/x-matroska"
    }
    var extTypes = { 
        "3gp"   : "video/3gpp"
    ...
    return {
        ...
        getContentTypeBySig: function(data) {
            ...
            if ( data.length > 0 ){          
                ...
                return (match.length ? magicNumbers[ match[ 1 ] ] : 'application/octet-stream'); 
            } 
        }
    };
}();
